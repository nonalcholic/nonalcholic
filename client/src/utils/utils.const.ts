...
export const MBTIResult: {
  ...
  ISFJ: {
    ...
    place: "귀여운 고양이 옆이면 어디든",
    subtitle: "온화한 원칙주의자,\n봄날의 햇살 스타일이에요!",
    description:
      "누군가를 챙기는 것을 좋아하는 당신. 혹시 캠퍼스 곳곳에 보이는 고양이들이 보일 때마다 마음이 쓰이지는 않았나요? 차분하고 따뜻한 성격 덕분에 캠퍼스 고양이들에게 인기가 많네요. 많은 사람들과 함께 노는 걸 크게 좋아하는 편은 아니지만, 가끔 있는 작은 모임들은 즐겁게 참여하는 타입이에요. 계획 세우는 걸 좋아해 친구들과의 일정이 있으면 앞장서서 주도하기도 해요. 배려심 가득한 당신에게 귀여움 받는 고양이들이 부러워요!",
  },
  ISFP: {
    abstract: "기숙사 방 침대",
    title: '"아 진짜 10분 뒤에는 교분간다"',
    place: "수면바지 입고 누워있는 기숙사 방 침대",
    subtitle: "침대와 물아일체,\n집돌이/집순이 스타일이에요!",
    description:
  ...
  ISTJ: {
    ...
    place: "열심히 필기하면서 앉아있는 창의관 교실 맨 앞자리",
